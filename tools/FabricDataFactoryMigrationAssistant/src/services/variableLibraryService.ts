...
class VariableLibraryService {
  ...
  async createVariableLibrary(
    ...
    try {
      ...
      const apiUrl = `https://api.fabric.microsoft.com/v1/workspaces/${workspaceId}/items`;
  ...
  async checkLibraryExists(
    ...
    try {
      const apiUrl = `https://api.fabric.microsoft.com/v1/workspaces/${workspaceId}/items?type=VariableLibrary`;
